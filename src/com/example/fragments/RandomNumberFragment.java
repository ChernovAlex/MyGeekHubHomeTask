...
public class RandomNumberFragment extends Fragment {
    ...
    public static RandomNumberFragment newInstance(String text) {
        RandomNumberFragment f = new RandomNumberFragment();
        Bundle args = new Bundle();
        args.putString(DetailFragment.TEXT_MESS, text);
        f.setArguments(args);
        return f;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            text = args.getString(DetailFragment.TEXT_MESS);
        }
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.rnd_nm_fragment, container, false);
        return view;
    }
